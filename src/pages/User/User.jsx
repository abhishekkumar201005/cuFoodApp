...
const User = () => {
  ...
  let data5 = [{ title: 'Yours Booking', hash: 'bookings' }];

  let data3 = [
    {
      userId: 123,
      imgSrc: userImg,
      userName: 'Mayank Punia',
      reviews: 20,
      followers: '1',
    },
    {
      ...
      <div className={css.box}>
        ...
        <div className={css.mainbody}>
          <div className={css.leftBox}>
            ...
            <SuggestedFollowCard
              name="SUGGESTED FOODIES TO FOLLOW"
              data={data3}
            />
            <ProfileWidget
              name="ZOMATO PROFILE WIDGET"
              tag="Showcase your Zomato profile on your blog."
              data={data4}
            />
          </div>
