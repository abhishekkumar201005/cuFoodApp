        ...
        <div className={css.innerDiv}>
            ...
            <div className={css.div2}>
                ...
                <div className={css.cards}>
                    <Card5 step='1' title='Create your page on CUFoodApp' tag='Help users discover your place by creating a listing on CUFoodApp' img={bookIcon} color='#FFFCF1' />
                    <Card5 step='2' title='Register for online ordering' tag='And deliver orders to thousands of customers with ease' img={bikeIcon} color='#FFF5F6' />
