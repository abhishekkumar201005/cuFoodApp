    ...
    return <div className={footerCss.footer}>
        <div className={footerCss.innerFooter}>
            <div className={footerCss.sec1}>
                <div className={footerCss.logoBox}>CUFoodApp</div>
            ...
            <div className={footerCss.sec2}>
                <div className={[footerCss.box1, footerCss.box].join(' ')}>
                    <div className={footerCss.boxTtl}>ABOUT CUFoodApp</div>
                ...
                <div className={[footerCss.box2, footerCss.box].join(' ')}>
                    <div className={footerCss.boxTtl}>CUFoodVerse</div>
                    <a href="" className={footerCss.boxOpt}>CUFoodApp</a>
                ...
                <div className={[footerCss.box3, footerCss.box].join(' ')}>
                    ...
                    <a href="" className={footerCss.boxOpt}>CUFoodApp For Work</a>
                </div>
            ...
            <div className={footerCss.sec3}>
                By continuing past this page, you agree to our Terms of Service, Cookie Policy, Privacy Policy and Content Policies. All trademarks are properties of their respective owners. 2022-2023 © CUFoodApp™ Ltd. All rights reserved.
            </div>
        </div>
    </div>
}
