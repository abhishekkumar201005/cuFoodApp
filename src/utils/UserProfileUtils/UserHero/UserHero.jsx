...
import user from '/icons/biryaniC.jpg'
            ...
            <div className={css.txtBox}>
              <div className={css.leftBox}>
                ...
                <div className={css.profileDetails}>
                  <div className={css.name}>Mayank Punia</div>
                  <span className={css.location}> <img src={location} className={css.locationIcon} /> Mohan Nagar</span>
                </div>
              </div>
